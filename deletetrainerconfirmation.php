    ...
    <div class="row d-flex justify-content-center">
                <div class="col-md-6 text-center">
                    ...
                    <form action="deletetrainer.php" method="POST">
                        <input type="hidden" name="delete_tid" id="delete_tid" value="<?php echo $id?>">
                        ...
                        <br>
                        <div class="mb-3">
                            <button type="submit" name="deletetcon" class="btn btn-danger">Delete</button>
                            <a href="index.php">
        ...
        <!-- <div class="justify-content-center">
            <form action="deletetrainer.php" method="POST">
                    <div class="col-md-12">
                        <input type="hidden" name="delete_tid" id="delete_tid">
                        <p>Are you sure you want to delete this record?</p>
                    </div>
                    <div class="col-md-12">
                        <a href="index.php">
